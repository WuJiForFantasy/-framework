...
//    CGRect rect = [_attString boundingRectWithSize:CGSizeMake(200, 2000) options:NSStringDrawingUsesLineFragmentOrigin context:nil];
//    NSLog(@"%@",NSStringFromCGRect(rect));
    ...
    NSLog(@"%d",[textContainer getHeightWithFramesetter:framesetter Width:CGRectGetWidth(self.view.frame)]);
...
- (void)addTextAttributedLabel1
{
    ...
    _label1 = label1;
    NSLog(@"%@",NSStringFromCGRect(label1.frame));
}

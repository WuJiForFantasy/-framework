...
- (void)addTextAttributedLabel1
{
    ...
    for (NSString *text in textArray) {
        ...
        if (index == 2) {
            // 追加链接信息
            [label1 appendLinkWithText:@"http://www.baidu.com" linkFont:[UIFont systemFontOfSize:15+arc4random()%4] linkData:@"http://www.baidu.com"];
        }else {
            // 追加文本属性
...
//    }
    ...
    label2.text = @"2133124324343243423423423455425234 http://www.baidu.com2135345423";
//    [label2 addTextStorageArray:textRunArray];
    
    label2.linesSpacing = 8;
    label2.characterSpacing = 2;
    [label2 setFrameWithOrign:CGPointMake(0,300) Width:CGRectGetWidth(self.view.frame)];
